 ...
 *
 * The reference this design follows carries its personality in scattered
 * marker doodles rather than in photography, which matters here because the
 * supplied artwork is flat placeholder colour. Every mark below is a drawn
 * path, so the charm costs a few hundred bytes and no image requests.
 *
 * They drift on a long, slow loop. Bounded to a gentle translate so nothing
 * ever competes with the content, and switched off entirely under
